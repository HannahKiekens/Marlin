...
#define STRING_CONFIG_H_AUTHOR "(Yannick Kiekens, Hannah/Lien)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Hannah/Lien 3DPrinter"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "6ad2f5e8-3068-4c78-aad8-ee834a50e093"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.2, 80.2, 4000, 1360}  // default steps per unit for Ultimaker
